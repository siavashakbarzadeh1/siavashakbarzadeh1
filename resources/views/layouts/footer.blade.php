            ...
            <section class="py-4  ">
                <div class="row">
                    <div class="col-lg-6 col-md-6 pl-5">
                        <h4>
                            <a href="#" title="Vai alla pagina: Amministrazione">Amministrazione
                                trasparente</a>
                        </h4>
                        <p>
                        ...
                        <ul class="list-inline text-left social">
                            <li class="list-inline-item">
                                <a class="p-2 text-white" href="#" target="_blank">
                                    <svg class="icon icon-sm icon-white align-top">
                                        <use
                                            xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-designers-italia">
                                        </use>
                                    </svg>
                            ...
                            <li class="list-inline-item">
                                <a class="p-2 text-white" href="#" target="_blank">
                                    <svg class="icon icon-sm icon-white align-top">
                                        <use
                                            xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-medium">
                                        </use>
                                    </svg>
                            ...
                            <li class="list-inline-item">
                                <a class="p-2 text-white" href="#" target="_blank">
                                    <svg class="icon icon-sm icon-white align-top">
                                        <use
                                            xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-behance">
                                        </use>
                                    </svg>
