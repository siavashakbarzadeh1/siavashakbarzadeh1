            ...
            <div class="row">
                <div class="col-12">
                    <div class="it-header-slim-wrapper-content">
                        <a class="d-lg-block navbar-brand" href="#">NOME CLIENTE</a>
                        <div class="header-slim-right-zone">
                            <div class="nav-item dropdown">
                                <a aria-expanded="false" class="nav-link dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    <svg class="icon icon-white d-none d-lg-block">
                                        <use
                                            xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-expand">
                                        </use>
                                    </svg>
                                </a>
                            ...
                            {{-- @auth --}}
                            <div class="col-2">
                            <button onclick="event.preventDefault(); window.location=this.getAttribute('href')" class="btn btn-primary btn-sm" href="{{route ('user-welcome2')}}" type="button"> Accedi</button>
                            </div>
                        ...
                        <div class="it-header-center-content-wrapper">
                            ...
                            <div class="it-brand-wrapper">
                                <a href="#">
                                    <svg class="icon">
                                        <use
                                            xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-pa">
                                        </use>
                                    </svg>
                                    ...
                                    <ul>
                                        <li>
                                            <a aria-label="Facebook" href="#" target="_blank">
                                                <svg class="icon">
                                                    <use
                                                        xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-facebook">
                                                    </use>
                                                </svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a aria-label="Github" href="#" target="_blank">
                                                <svg class="icon">
                                                    <use
                                                        xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-github">
                                                    </use>
                                                </svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a aria-label="Twitter" href="#" target="_blank">
                                                <svg class="icon">
                                                    <use
                                                        xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-twitter">
                                                    </use>
                                                </svg>
                                            </a>
                                        </li>
...
<!-- here -->
                                  <a aria-label="Accesss" class="search-link rounded-icon" title="area di accessibilità" href="#" onclick="document.getElementById('accessibility').style.visibility='visible';document.getElementById('accessibility').style.display='block';">
                                        <svg class="icon" >
                                            <use
                                                xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-user">
                                            </use>
                                        </svg>
                                    </a>
                                </div>
                                ...
                                <div class="it-search-wrapper">
                                    ...
                                    <a aria-label="Cerca" class="search-link rounded-icon" href="#">
                                        <svg class="icon">
                                            <use
                                                xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-search">
                                            </use>
                                        </svg>
                                    </a>
                                </div>
                    ...
                    <div class="col-12">
                        <nav class="navbar navbar-expand-lg has-megamenu">
                            <button aria-controls="nav10" aria-expanded="false" aria-label="Toggle navigation"
                                ...
                                <svg class="icon">
                                    <use
                                        xlink:href="{{ asset('vendor/') }}/bootstrap-italia/dist/svg/sprite.svg#it-burger">
                                    </use>
                                </svg>
                            </button>
