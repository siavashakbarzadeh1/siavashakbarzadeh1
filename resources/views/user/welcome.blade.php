...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Benvenuto</li>
    </ol>
@stop
    ...
    <div class="container position-relative">
        <div class="row">
            ...
            <div class="col-xl-12 position-static">
                <h1 class="text-left">Utente Mario Rossi</h1>
            </div>
                                        ...
                                        <table class="table mb-0 bg-white">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">Attività amministrativa</td>
